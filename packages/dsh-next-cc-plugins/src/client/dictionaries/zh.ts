...
export const zh: Record<MessageKey, string> = {
  ...
  'marketplaces.refreshing': '正在刷新…',
  'marketplaces.refreshProgress': '正在刷新 {done}/{total}…',
  'marketplaces.refreshedAll': '已刷新 {count} 个市场',
  'marketplaces.refreshFailed': '{count} 个市场刷新失败：{items}',
