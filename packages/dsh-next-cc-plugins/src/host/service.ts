...
import { dependencyNotes, pluginInventory, pluginLevelReferenceNotes, readManifestPaths, skillFiles, unbridgedNotes, type PluginFiles } from '../core/plugin-inventory.ts'
...
export class CcMarketplaceService {
  ...
  async installPlugin(args: {
    ...
    const notes = [...mcp.notes, ...agents.notes, ...unbridgedNotes(inventory.unbridged), ...dependencyNotes(inventory.dependencies), ...pluginLevelReferenceNotes(resolved.files, inventory.skills)]
