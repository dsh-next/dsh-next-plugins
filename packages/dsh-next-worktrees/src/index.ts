 ...
 * inside a linked worktree (proven in docs/archive/2026-09-04-worktrees-m0-probe.md).
 */
...
export function apply(ctx: Context): void {
  ...
  const service = new WorktreesService({ git, store, getSessionCwd, applySandboxMode })
